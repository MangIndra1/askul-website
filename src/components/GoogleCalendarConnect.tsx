...
import { GoogleAccountMenu } from '@/components/GoogleAccountMenu'
...
export async function GoogleCalendarConnect() {
  ...
  return (
    <a
      href={authUrl}
      className="glass flex w-full items-center justify-center gap-2.5 rounded-2xl px-4 py-3.5 text-sm font-semibold text-[var(--dk-text)] transition hover:bg-white/[0.06]"
    >
